...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { references: @nearest_station.references, route_name: @nearest_station.route_name, station_name: @nearest_station.station_name, walk_time: @nearest_station.walk_time } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { references: @nearest_station.references, route_name: @nearest_station.route_name, station_name: @nearest_station.station_name, walk_time: @nearest_station.walk_time } }
